...
START TRANSACTION;
USE `Kibsur`;
INSERT IGNORE INTO `Kibsur`.`Stores` (`store_id`, `address`, `city`, `state_or_provence`, `postal_code`) VALUES (1, '234 fake st', 'Springfield', 'IN', NULL);
INSERT IGNORE INTO `Kibsur`.`Stores` (`store_id`, `address`, `city`, `state_or_provence`, `postal_code`) VALUES (2, '456 lorem dr', 'St. Louis', 'MO', NULL);
INSERT IGNORE INTO `Kibsur`.`Stores` (`store_id`, `address`, `city`, `state_or_provence`, `postal_code`) VALUES (3, '890 paper ln', 'Baton Rouge', 'LA', NULL);
INSERT IGNORE INTO `Kibsur`.`Stores` (`store_id`, `address`, `city`, `state_or_provence`, `postal_code`) VALUES (4, '867 sesame st', 'New York', 'NY', NULL);
...
START TRANSACTION;
USE `Kibsur`;
INSERT IGNORE INTO `Kibsur`.`Categories` (`category_id`, `category_name`, `parent_category`) VALUES (1, 'Items', 1);
